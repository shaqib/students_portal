...
public class EnrollmentControllerTest {
    ...
    private static final StudentDTO STUDENT1 = StudentDTO.builder().firstName("Mohammad").lastName("Shaqib").studentClass("1A").nationality("Indian").build();
    private static final StudentDTO STUDENT2 = StudentDTO.builder().firstName("Ajeet").lastName("Singh").studentClass("1A").nationality("Singaporean").build();
    private static final StudentDTO STUDENT3 = StudentDTO.builder().firstName("Michael").lastName("Wong").studentClass("1A").nationality("Hong Kong").build();
    private static final StudentDTO STUDENT4 = StudentDTO.builder().firstName("Harry").lastName("Li").studentClass("1A").nationality("Hong Kong").build();
